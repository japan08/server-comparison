...
DEFAULT_FALLBACK_DATABASE_URL = (
    f"sqlite+aiosqlite:///{Path(gettempdir()) / 'cloud_compare.db'}"
)
...
def get_settings() -> object:
    ...
    fallback_url = os.getenv("FALLBACK_DATABASE_URL", DEFAULT_FALLBACK_DATABASE_URL)
